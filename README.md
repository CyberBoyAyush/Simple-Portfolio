...
Download [Source Code Zip](# Simple-Portfolio
A simple single page portfolio which is easy to edit and easy to deploy.
...
# Host it on your own server (Hosting Or Cloud)
Download [Source Code Zip](https://github.com/CyberBoyAyush/Simple-Portfolio/archive/refs/tags/Download-Source.zip) and add it in your hosting file manager.
...
) and add it in your hosting file manager.
